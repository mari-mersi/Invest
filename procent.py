...
sale = float(input("Цена акции при продаже: "))
a = comission(buy, n)  # Расчет комиссии при покупках
b = comission(sale, n)
...
proc = (sale / ((((a + c) / (n * 0.87)) + buy) * (1 + inf / 100)) - 1) * 100
doxod = (0.87 * n * (sale - buy) - a - c) * (1 + inf / 100) * (1 + proc / 100)

# print("Акция должна стоить: ",sale)
print("Сумма комиссий: ", a + b + c)
print("Доход составит: ", doxod, "руб")
print("Доход составит: ", proc, "%")
